...
export default function SiteBanner() {
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 items-center">
                    <div className="space-y-4 md:space-y-6">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 tracking-tight">
                            We're <span className="text-amber-500">Review Hub</span>
                        </h2>
                    ...
                    <div
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
                            ...
                            <div
                                className="flex-[1] flex justify-center sm:justify-end items-center sm:items-end mt-4 sm:mt-0">
    ...
    return (
        <motion.div
            ...
            className="w-full bg-white rounded-3xl p-6 sm:p-8 md:p-12 shadow-lg overflow-hidden"
            initial="hidden"
            animate={controls}
        ...
        >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 items-center">
                ...
                {/* Right section */}
                <motion.div
                    className="bg-gradient-to-br from-amber-100 to-amber-200 text-white p-5 sm:p-6 md:p-8 rounded-2xl shadow-lg"
                    variants={itemVariants}
                    initial={{opacity: 1}}
                    whileInView={{
                        scale: [0.9, 1],
