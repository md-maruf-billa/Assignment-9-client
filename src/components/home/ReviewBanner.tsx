...
export default function ReviewBanner() {
    ...
    if (!isMounted) {
        return (
            <div
                className="w-full bg-gradient-to-br from-orange-50 to-orange-200 rounded-xl p-6 sm:p-8 md:p-12 shadow-lg relative">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
                    <div className="flex flex-col justify-center">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 text-gray-900">
                            Help millions make the{' '}
                            <span className="text-amber-500">right choice</span>
                        </h2>
                        ...
                        <div className="flex flex-wrap gap-4">
                            <Button className=" shadow-md bg-amber-500 hover:bg-amber-600">
                                Login or sign up
                            </Button>
