...
export default function SiteReview({products}: { products: Product[] }) {
    ...
    return (
        <div ref={sectionRef} className="mx-auto py-6 md:py-10">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-2">
                <h2 className="text-xl md:text-2xl lg:text-3xl font-semibold text-amber-500">Best in Product</h2>
                <Link href="/product">
            ...
            {products.length > 0 ? (
                ...
                >
                    {products.slice(0, 8).map((product) => (
                        ...
                        >
                            <div className="relative h-48 w-full bg-gray-100">
                                ...
                                />
                                <div
                                    className="absolute top-4 right-4 bg-amber-500 text-white text-sm font-bold px-3 py-1 rounded-full">
                    ...
                    Post: {new Date(product.createdAt).toLocaleDateString()}
                  </span>
                                </div>
                            </div>
                        </motion.div>
