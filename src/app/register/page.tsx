            ...
            <div className="min-h-screen bg-[#FAF8F5] flex flex-col font-sans">
                ...
                <main className="flex flex-col md:flex-row items-center justify-center gap-10 md:gap-36 mx-auto w-full p-6 md:p-10">
                    ...
                    <div className="w-full max-w-md  mb-16 md:mb-0  ">
                        <h1 className="text-3xl font-bold text-gray-900 mb-2">Welcome To ReviewHub</h1>
                        <p className="text-gray-600 mb-8">Register a new account</p>

                        <form action="" onSubmit={handleSubmit}>
                            {/* Username Input */}
                            <div className="mb-5">
                                <label htmlFor="username" className="block text-sm font-medium text-gray-700 mb-1">Username
                                </label>
                                <input
                                    type="text"
                                    id="username"
                                    name="username"
                                    defaultValue="jhon123" // Default value as in image
                            ...
                            <div className="flex items-center justify-between mb-6">
                                ...
                                <a href="#" className="text-sm font-medium text-black-600 hover:underline">
                                    Forgot password?
                                </a>
                            </div>
