...
import { reset_password_action} from "@/services/AuthService";
...
function ResetPassword() {
    ...
    const handleSubmit = async (e: any) => {
        const id = toast.loading("Password resetting ...")
        e.preventDefault();
        const password = e.target.password.value.trim() as string;
        const res = await reset_password_action(email!,token!, password);
        console.log(res)
        if (res.success) {
            ...
            <div className="min-h-screen bg-[#FAF8F5] flex flex-col font-sans">
                ...
                <main className="flex flex-col md:flex-row items-center justify-center gap-10 md:gap-36 mx-auto w-full p-6 md:p-10">
                    ...
                    <div className="w-full max-w-md  mb-16 md:mb-0  ">
                        <h1 className="text-3xl font-bold text-gray-900 mb-2">Welcome back again 😍!</h1>
                        <p className="text-gray-600 mb-8 text-center">Set a secure password for next login.</p>
